...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { external_id: @apartment.external_id, floor_id: @apartment.floor_id } }, as: :json
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { external_id: @apartment.external_id, floor_id: @apartment.floor_id } }, as: :json
    assert_response 200
  end
